...
#}
#Restart
Write-SectionHeader -Message "📦 Instalacja dodatkowego oprogramowania"

# 🔹 7-Zip (najnowsza wersja)
Write-Host "⬇️ Instalacja najnowszego 7-Zip"
$zipPage = Invoke-WebRequest -Uri "https://www.7-zip.org/download.html"
$zipMatch = ($zipPage.Links | Where-Object { $_.href -match "7z\d{4}-x64\.exe" })[0].href
$zipUrl = "https://www.7-zip.org/$zipMatch"
$zipPath = "$env:Temp\7zSetup.exe"
Invoke-WebRequest -Uri $zipUrl -OutFile $zipPath
Start-Process -FilePath $zipPath -ArgumentList "/S" -Wait

# 🔹 Google Chrome (najnowsza wersja MSI)
Write-Host "⬇️ Instalacja najnowszego Google Chrome"
$chromeUrl = "https://dl.google.com/dl/chrome/install/googlechromestandaloneenterprise64.msi"
$chromePath = "$env:Temp\Chrome.msi"
Invoke-WebRequest -Uri $chromeUrl -OutFile $chromePath
Start-Process -FilePath "msiexec.exe" -ArgumentList "/i `"$chromePath`" /qn /norestart" -Wait

# 🔹 Microsoft Teams (nowy, MSIX, per-machine)
Write-Host "⬇️ Instalacja Microsoft Teams (New)"
$teamsUrl = "https://statics.teams.cdn.office.net/production-windows-x64/enterprise/webview2/lkg/MSTeams-x64.msix"
$teamsPath = "$env:Temp\MSTeams-x64.msix"
